...
###  install
     ...
     `npm install react-native-my-vlcplayer --save`
...
Run `react-native link react-native-my-vlcplayer`
...
##  VLCPlayer props
    ...
    import { VLCPlayer } from 'react-native-my-vlcplayer';
...
##  use plugin
````
   import { VLCPlayer, VlCPlayerView } from 'react-native-my-vlcplayer';
...
````
   ...
   (2)
       ...
       import { VLCPlayer, VlcSimplePlayer } from 'react-native-my-vlcplayer';
       import Orientation from 'react-native-orientation';
...
````
    ...
    import {VlcSimplePlayer, VLCPlayer}  from 'react-native-my-vlcplayer';
