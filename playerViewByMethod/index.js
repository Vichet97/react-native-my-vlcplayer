...
export default class VlCPlayerViewByMethod extends Component {
    ...
    static defaultProps = {
        ...
        vipEndViewText: {
            vipEndText: 'VIP Ended',
            boughtBtnText: 'Buy Now',
        },
        chapterText: 'Chapter',
        autoplay: false,
        showAd: false,
     ...
     * @private
     */
    _onProgress = ({ currentTime, totalTime }) => {
        ...
        //console.log('_onProgress:'+currentTime + ","+totalTime)
        let { useVip, vipPlayLength, onProgress } = this.props;
        if (useVip) {
            ...
            onProgress && onProgress({ currentTime, totalTime });
        }
    };
    ...
    _onEnd = (data) => {
        ...
        if(duration){
            ...
            if(!isLive){
                ...
                console.log('Live Stopped, Reload')
                this._onStopped('Live Stopped, Reload')
            }
        }
    ...
    _onAdBuffering = e => {
        ...
        this.props.onAdBuffering && this.props.onAdBuffering(e);
    }
    ...
    _onAdIsPlaying = (e)=> {
        ...
        this.props.onAdIsPlaying && this.props.onAdIsPlaying(e);
    }

    _onAdOpen = (e)=> {
        this.props.onAdOpen && this.props.onAdOpen(e);
    }
    ...
    _onAdStopped = (e)=> {
        ...
        this.vlcPlayerViewAdRef && this.vlcPlayerViewAdRef.play();*/
        this.props.onAdStopped && this.props.onAdStopped(e);
    }
    ...
    _onAdLoadStart = e=> {
        ...
        this.initAdSuccess = false;
        this.props.onAdLoadStart && this.props.onAdLoadStart(e);
    }
    ...
    _onAdEnd = e => {
        ...
        /*this.vlcPlayerViewAdRef && this.vlcPlayerViewAdRef.seek(0);
        this.vlcPlayerViewAdRef && this.vlcPlayerViewAdRef.play();*/
        this.props.onAdEnd && this.props.onAdEnd(e);
    }
